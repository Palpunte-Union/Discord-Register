...
public final class DiscordRegister extends JavaPlugin {

    public static DiscordRegister instance;
                        ...
                        if(RegisterHash.get(uuid).equals(key)) {
                            Objects.requireNonNull(channel).createEmbed(spec ->
                                    spec.setColor(Color.RED)
                                            .setAuthor(e.getMessage().getAuthor().get().getUsername(), "https://github.com/Palpunte-Union", e.getMessage().getAuthor().get().getAvatarUrl())
                                            ...
                                            .setFooter("ぱるぷんて連合 / Union Palpunte", "https://raw.githubusercontent.com/Palpunte-Union/Default/master/resources/mini-icon.png")
                            ...
                            DiscordRegister.getInstance().updateConfig();
                        }
                    }
                }
            });
    ...
    public static DiscordRegister getInstance() {
        return instance;
    }
}
